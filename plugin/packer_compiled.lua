...
_G.packer_plugins = {
  ...
  ["darkplus.nvim"] = {
    loaded = true,
    path = "/home/andres/.local/share/nvim/site/pack/packer/start/darkplus.nvim",
  ...
  ["impatient.nvim"] = {
    loaded = true,
    path = "/home/andres/.local/share/nvim/site/pack/packer/start/impatient.nvim",
  ...
  ["vim-bbye"] = {
    loaded = true,
    path = "/home/andres/.local/share/nvim/site/pack/packer/start/vim-bbye",
